...
\todo{Insert product photo here --- full device, front and back views.}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.5\textwidth]{figures/product_photo.jpg}
%     \caption{The selected disposable electronic cigarette: \todo{Brand/Model Name}.}
%     \label{fig:product_photo}
% \end{figure}

The product selected for this project is a disposable electronic cigarette (e-cigarette), also known as a single-use vape. \todo{Specify exact brand, model, and where it was purchased. Include approximate retail price (must be under \$20).}
