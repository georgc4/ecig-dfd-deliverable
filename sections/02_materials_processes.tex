...
The Air Bar NEX 3K was sealed via press-fit (mouthpiece into aluminum shell body). Disassembly required an X-acto knife to separate the mouthpiece from the body and was \textbf{destructive}---the press-fit joint was permanently deformed during removal. Reaching the battery required approximately \textbf{10 distinct steps} and took \textbf{10--15 minutes}, confirming that the current design is not intended for disassembly or component recovery.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/makerspace/IMG_6141.png}
    \caption{Disassembled Air Bar NEX 3K showing all distinct components (left to right): mouthpiece, battery (13450 Li-ion), reservoir/atomizer assembly, inner chassis with PCB, and aluminum housing. Makerspace session, 3/2/26.}
    \label{fig:disassembly_overview}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/makerspace/IMG_6136.png}
        \caption{Battery and PCB extracted, showing wired connections.}
        \label{fig:disassembly_battery}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.45\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/makerspace/IMG_6138.png}
        \caption{Inner chassis with PCB, LED, and airflow sensor.}
        \label{fig:disassembly_pcb}
    \end{subfigure}
    \caption{Close-up views from destructive disassembly of the Air Bar NEX 3K.}
    \label{fig:disassembly_details}
\end{figure}
...
\begin{enumerate}
    ...
    \item \textbf{Solder} (PCB joints): Likely lead-free (Sn-Ag-Cu) solder based on RoHS compliance markings on the device.
...
\begin{enumerate}
    ...
    \item Through-hole soldering for leaded components (e.g., USB-C port)
